...
export const zhCN: Dict = {
  ...
  'tool.source': '源码',
  'tool.diff': '差异',
  'fileActivity.title': '文件变更',
  'fileActivity.created': '创建',
  'fileActivity.modified': '修改',
  'fileActivity.deleted': '删除',
  'screenshots.title': '截图',
  'screenshots.capture': '截图',
  'screenshots.desktop': '桌面端',
  'screenshots.tablet': '平板端',
  'screenshots.mobile': '移动端',
